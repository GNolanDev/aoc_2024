...
fn main() {
    ...
    // for each tuple, search the adjacent coordinates in the topo_grid for the target int, push all the coords into a new set, increment the target & call the function again
